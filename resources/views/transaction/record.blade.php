...
<div class="card mt-10 mb-5">
    <div class="card-header text-center fw-bold text-uppercase text-white bg-dark mb-10">
        Daftar Riwayat Pemakaian Mobil
    </div>
    <div class="card-body bg-light mt-10">
        <div class="card-body">
            <div class="card-body table-responsive text-center p-1">
                <table class="table table-bordered table-hover text-center align-middle stripe" id="record-booking-cars" style="width: 100%;">
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#record-booking-cars').DataTable({
            responsive: true,
            rowReorder: {
