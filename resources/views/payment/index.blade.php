    ...
    <div class="card-body bg-light mt-10">
        <div class="card-body">
            {{-- <div class="d-flex mt-2 mb-2 p-1">
                <a href="{{ route('transaction.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Proses Bayar</a>
            </div> --}}
            <div class="card-body table-responsive text-center p-1">
                <table class="table table-bordered table-hover text-center align-middle stripe" id="payment-cars" style="width: 100%;">
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#payment-cars').DataTable({
            responsive: true,
            rowReorder: {
