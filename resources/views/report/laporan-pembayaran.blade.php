        ...
        <div class="card">
            <div class="card-body table-responsive text-center mt-5 p-2">
                <div class="table-responsive text-center p-1">
                    <table class="table table-bordered table-hover align-middle stripe display nowrap" id="laporan-pembayaran" style="width: 100%">
                ...
                },
                {
                    ...
                    render: function(data) {
                        if (data == 'PAID') {
                            ...
                            return "<span class=\"badge bg-danger text-uppercase\">piutang</span>";
                        }
                    }
                },
            ],
