        ...
        <div class="card">
            <div class="card-body table-responsive text-center mt-5 p-2">
                <div class="table-responsive text-center p-1">
                    <table class="table table-bordered table-hover align-middle stripe display nowrap" id="laporan-mobil" style="width: 100%">
...
<script type="text/javascript">
    $(function() 
    {
        var table = $('#laporan-mobil').DataTable({
            dom: 'Blfrtip',
