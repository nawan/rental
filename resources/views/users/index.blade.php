    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <div class="d-flex mt-4 mb-3">
                <a href="{{ route('user.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Tambah Pelanggan</a>
            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="input-group mb-3">
                                <input type="text" value="{{ Request::input('search') }}" class="form-control" placeholder="nama pelanggan..." name="search">
                    ...
                    @forelse($users as $user)
                        ...
                        <th scope="row" class="align-middle">{{ $loop->iteration }}</th>
                            ...
                            <td class="align-middle">
                                ...
                                <a href="{{ route('user.edit',$encryptID) }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <div class="card-group bg-light mt-10">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="cad-body text-center mb-3" style="400px">
                                                                ...
                                                                <button type="button" class="btn btn-info btn-sm mb-3"><a href="{{ route('user.show', $encryptID) }}" class="text-white" style="text-decoration: none">Lihat Detail</a></button>
                                                            </div>
                                                        </div>
                                                    </div>
